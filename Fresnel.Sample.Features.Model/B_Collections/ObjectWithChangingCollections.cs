...
namespace Envivo.Fresnel.Sample.Features.Model.B_Collections
{
    ...
    /// </summary>
    public class ObjectWithChangingCollections
    {
        private ICollection<BasicObject> _PreDefinedItems;
        ...
        /// </summary>
        public List<BasicObject> Items { get; internal set; } = new List<BasicObject>();
        ...
        private ICollection<BasicObject> CreatePreDefinedItems()
        {
            return
                Enumerable.Range(1, ItemsPerPage * 4)
                .Select(i => new BasicObject
                {
                    Id = Guid.NewGuid(),
                    Name = $"Item No{i}",
