...
namespace Envivo.Fresnel.Sample.Features.Model.B_Collections
{
    ...
    public class OtherCollectionExamples
    {
        ...
        public ICollection<BasicObject> CreateAssociateRemove { get; internal set; } = new List<BasicObject>();
        ...
        public ICollection<BasicObject> AddNewAndAssociate { get; internal set; } = new List<BasicObject>();
        ...
        public ICollection<BasicObject> AddNewOnly { get; internal set; } = new List<BasicObject>();
        ...
        public ICollection<BasicObject> AssociateExistingOnly { get; internal set; } = new List<BasicObject>();
        ...
        public ICollection<BasicObject> NoOperationsAllowed { get; internal set; } = new List<BasicObject>();
    }
}